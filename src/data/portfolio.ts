...
export const portfolioData: PortfolioData = {
  profile: {
    name: '王璐迪',
    role: '视频剪辑 / 内容剪辑 / 后期助理',
    tagline: '动漫制作技术专业应届生，擅长视频剪辑、字幕配合、配乐节奏和视觉表达，适合投递视频剪辑相关岗位。',
    intro:
      '我目前就读于郑州城市职业学院动漫制作技术专业，专业排名前 5%，获得国家励志奖学金。课程展示和小组作业中，我长期负责视频剪辑、字幕、配乐和内容整理，也会从画面节奏、字幕配合和整体氛围去调整成片表达。这个站点会先展示作品，再补充和视频剪辑岗位最相关的教育背景、后期能力和实践经历。',
    location: '教育背景 · 郑州城市职业学院动漫制作技术 / 求职方向 · 视频剪辑',
  ...
  skills: [
    ...
    { name: '字幕与配乐', detail: '能根据画面内容安排字幕节奏、停顿和音乐进入点，提升成片完整度' },
    { name: '内容整理', detail: '能配合文案和内容结构完成素材整理、镜头取舍和信息顺序调整' },
    { name: '视觉审美', detail: '动漫设计专业背景，具备构图、配色和画面氛围判断能力' },
  ],
  highlights: [
    {
      title: '课程展示剪辑经验',
  ...
  resumeSections: [
    ...
    },
    {
      ...
      title: '剪辑实践经历',
      items: [
        '课程展示中负责视频剪辑与后期，能独立完成素材整理、剪辑、字幕、配乐和节奏控制。',
        '小组作业中承担文案与内容结构设计，能配合剪辑需求梳理镜头顺序和信息重点。',
    ...
    },
    {
      ...
      items: [
        '软件：剪映（熟练）、AE、PS',
        '可完成基础剪辑、字幕包装、音乐搭配和成片节奏调整',
        '适合课程展示、短视频内容和基础包装类任务',
      ],
    },
  ],
  categories: [
